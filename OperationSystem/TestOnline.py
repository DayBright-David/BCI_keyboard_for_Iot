...
config.expINFO(winLEN=0.3, trainBlockNUM=0, testBlockNUM=8, paradigm=paradigm)
config.connectINFO(streaming_ip='10.0.0.2',streaming_port=4000,host_ip='10.0.0.3')
